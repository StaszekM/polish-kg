# https://github.com/WebNLG/WebNLG-Text-to-triples/blob/master/Evaluation_script_json.py
...
def evaluaterefcand(reference, candidate):
    ...
    for idx, attrib in enumerate(indextriple):
        ...
        reflist = nltk.word_tokenize(refsub, language='polish')
        candlist = nltk.word_tokenize(candsub, language='polish')
